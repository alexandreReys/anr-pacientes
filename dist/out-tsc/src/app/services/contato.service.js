...
var ContatoService = /** @class */ (function () {
    function ContatoService(httpClient, loginService) {
        ...
        this.subject = new BehaviorSubject(this.contato);
    }
    ContatoService.prototype.setDados = function (contato) {
        this.subject.next(contato);
    };
    ContatoService.prototype.getContatos = function (search) {
        if (search) {
            var urlGet = APP_API + "/contatos/" + search + "?idEmpresa=" + this.loginService.user.idEmpresaUsuario;
            return this.httpClient
                .get(urlGet, { headers: this.getHeaders() })
                .pipe(catchError(function (error) { return ErrorHandler.handleError(error); }));
        }
        else {
            var urlGet = APP_API + "/contatos?idEmpresa=" + this.loginService.user.idEmpresaUsuario;
            return this.httpClient
                .get(urlGet, { headers: this.getHeaders() })
                .pipe(catchError(function (error) { return ErrorHandler.handleError(error); }));
        }
    ...
    ContatoService.prototype.getContatosCodigo = function (codigoPaciente) {
        var urlGet = APP_API + "/contatos/codigo/" + codigoPaciente + "?idEmpresa=" + this.loginService.user.idEmpresaUsuario;
        return this.httpClient
            .get(urlGet, { headers: this.getHeaders() })
            .pipe(catchError(function (error) { return ErrorHandler.handleError(error); }));
    };
    ;
    ContatoService.prototype.getContatosId = function (idPaciente) {
        var urlGet = APP_API + "/contatos/id/" + idPaciente + "?idEmpresa=" + this.loginService.user.idEmpresaUsuario;
        return this.httpClient
            .get(urlGet, { headers: this.getHeaders() })
            .pipe(catchError(function (error) { return ErrorHandler.handleError(error); }));
    };
