...
var MedicoService = /** @class */ (function () {
    ...
    MedicoService.prototype.getMedicos = function (search) {
        if (search) {
            var urlGet = APP_API + "/medicos/" + search + "?idEmpresa=" + this.loginService.user.idEmpresaUsuario;
            return this.httpClient
                .get(urlGet, { headers: this.getHeaders() })
                .pipe(catchError(function (error) { return ErrorHandler.handleError(error); }));
        }
        else {
            var urlGet = APP_API + "/medicos?idEmpresa=" + this.loginService.user.idEmpresaUsuario;
            return this.httpClient
                .get(urlGet, { headers: this.getHeaders() })
                .pipe(catchError(function (error) { return ErrorHandler.handleError(error); }));
        }
    ...
    ;
    MedicoService.prototype.getMedicoById = function (idMedico) {
        var urlGet = APP_API + "/medicos/id/" + idMedico + "?idEmpresa=" + this.loginService.user.idEmpresaUsuario;
        return this.httpClient
            .get(urlGet, { headers: this.getHeaders() })
            .pipe(catchError(function (error) { return ErrorHandler.handleError(error); }));
    };
